export const codingSpec = [
    ...
    },
    {
        ...
        description: 'General demographic characteristics are important to record for each patient being investigated or treated for COVID-19.',
        bindings: [
            {
    ...
    },
    {
        ...
        description: 'Laboratory testing for COVID-19 and the associated SARS-CoV-2 virus includes methods that detect the presence of the virus and antibodies produced in response to infection, in specimen samples taken from potentially infected individuals. ',
        bindings: [
            {
            title: 'Specimen',
            type: 'dropdown',
